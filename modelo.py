...
valor_c = IntVar()
valor_d = IntVar()
Label(root,bg="#A52A2A").place(x=55, y=20, width=250, height=18)
Label(root, width=1, text="Tipo de Colarinho", bg="#A52A2A", font="Times 10 bold italic",
...
Label(root, text="Tipo de Frente", font="times 10 bold italic", bg="#A52A2A", fg="white").place(x=1, 
y=110, width=300, height=18)
...
Label(root, text="Bordado", font="times 10 bold italic", bg="#A52A2A", fg="white").place(x=1,
 y=185, width=300, height=18)
...
rd_43 = Radiobutton(root,
                    text="Manga curta ", bg="#deb887", variable=valor_d, value=2)
...
cmd = Button(root,text="Finalizar", font="times 8 ", fg="black", bg="gray", width=10, command=mostrar)
